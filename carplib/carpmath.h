...
// f32
CARP_FN f32 carp_math_abs_f(f32 a);
...
CARP_FN void carp_math_rotate_v3WithQuat(const CarpV3A* v, const CarpQuat* q, CarpV3A* outVec);
...
CARP_FN void carp_math_print_q(const CarpQuat* v, const char* name);
CARP_FN void carp_math_print_m34(const CarpM34* v, const char* name);
CARP_FN void carp_math_print_m44(const CarpM44* v, const char* name);
