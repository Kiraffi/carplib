...
clang mathtest.c -O2 -obuildout/mathtestclang.exe %links% && buildout\mathtestclang.exe > buildout/mathtestclang.txt
tcc mathtest.c -O2 -obuildout/mathtesttcc.exe %final% && buildout\mathtesttcc.exe > buildout/mathtesttcc.txt
